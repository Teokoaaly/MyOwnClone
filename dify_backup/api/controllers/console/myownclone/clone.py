<<<<<<<< HEAD:myownclone/api/controllers/console/myownclone/clone.py
"""myownclone clone configuration API — CRUD for clone identity, personality, and mode prompts."""
========
"""MyOwnClone clone configuration API — CRUD for clone identity, personality, and mode prompts."""
>>>>>>>> 1671d625db5e6a6fd0b701e0ac76d841aafcf5d6:dify_backup/api/controllers/console/myownclone/clone.py
