<<<<<<<< HEAD:myownclone/api/controllers/console/myownclone/stripe_ctrl.py
...
Uses the same Stripe key as Dify but adds MyOwnClone-specific product/price handling.
>>>>>>>> 1671d625db5e6a6fd0b701e0ac76d841aafcf5d6:dify_backup/api/controllers/console/myownclone/stripe_ctrl.py
"""
