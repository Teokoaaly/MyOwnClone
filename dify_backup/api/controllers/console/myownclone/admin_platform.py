<<<<<<<< HEAD:myownclone/api/controllers/console/myownclone/admin_platform.py
"""myownclone admin platform API — multi-tenant management, impersonation, MRR dashboard.
========
"""MyOwnClone admin platform API — multi-tenant management, impersonation, MRR dashboard.
>>>>>>>> 1671d625db5e6a6fd0b701e0ac76d841aafcf5d6:dify_backup/api/controllers/console/myownclone/admin_platform.py
...
class AdminImpersonateApi(Resource):
    ...
    def post(self):
        ...
        tenant_name = tenant.name if tenant and hasattr(tenant, 'name') else str(data.tenant_id)
