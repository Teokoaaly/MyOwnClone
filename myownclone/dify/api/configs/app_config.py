...
class RemoteSettingsSourceFactory(PydanticBaseSettingsSource):
    ...
    def __call__(self) -> dict[str, Any]:
        ...
        for field_name, field in self.settings_cls.model_fields.items():
          ***REMOVED***eld_value, field_key, value_is_complex = remote_source.get_field_value(field, field_name)
          ***REMOVED***eld_value = remote_source.prepare_field_value(field_name, field, field_value, value_is_complex)
...
class DifyConfig(
    ...
    def settings_customise_sources(
      ...
      ***REMOVED***le_secret_settings: PydanticBaseSettingsSource,
