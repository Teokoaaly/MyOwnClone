...
def build_from_mapping(
  ...
  ***REMOVED***le = build_func(
    ...
    if config and not is_file_valid_with_config(
      ...
      ***REMOVED***le_extension=file.extension or "",
      ***REMOVED***le_transfer_method=file.transfer_method,
        config=config,
    ):
...
def _build_from_local_file(
    *,
    ...
    with session_factory.create_session() as session:
      ...
      ***REMOVED***le_type = _resolve_file_type(
        ...
        return File(
          ***REMOVED***le_id=mapping.get("id"),
          ***REMOVED***lename=row.name,
    ...
    *,
    ...
    with session_factory.create_session() as session:
      ...
      ***REMOVED***le_type = _resolve_file_type(
        ...
        return File(
          ***REMOVED***le_id=mapping.get("datasource_file_id"),
          ***REMOVED***lename=datasource_file.name,
          ***REMOVED***le_type=file_type,
