...
that abstracts database queries currently ***REMOVED*** directly in service classes. This repository is
...
class WorkflowNodeExecutionSnapshot:
  ...
  ***REMOVED***nished_at: datetime | None  # Execution finished timestamp.
