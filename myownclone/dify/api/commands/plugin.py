...
def transform_datasource_credentials(environment: str):
    ...
    try:
      ...
      ***REMOVED***recrawl_plugin_id = "langgenius/firecrawl_datasource"
        jina_plugin_id = "langgenius/jina_datasource"
        if environment == "online":
            notion_plugin_unique_identifier = plugin_migration._fetch_plugin_unique_identifier(notion_plugin_id)
          ***REMOVED***recrawl_plugin_unique_identifier = plugin_migration._fetch_plugin_unique_identifier(firecrawl_plugin_id)
      ...
      ***REMOVED***:
          ...
          ***REMOVED***recrawl_plugin_unique_identifier = None
      ...
      ***REMOVED***recrawl_credentials = db.session.scalars(
            select(DataSourceApiKeyAuthBinding).where(DataSourceApiKeyAuthBinding.provider == "firecrawl")
        ).all()
        if firecrawl_credentials:
          ***REMOVED***recrawl_credentials_tenant_mapping: dict[str, list[DataSourceApiKeyAuthBinding]] = {}
            for firecrawl_credential in firecrawl_credentials:
                ...
                if tenant_id not in firecrawl_credentials_tenant_mapping:
                  ***REMOVED***recrawl_credentials_tenant_mapping[tenant_id] = []
              ***REMOVED***recrawl_credentials_tenant_mapping[tenant_id].append(firecrawl_credential)
