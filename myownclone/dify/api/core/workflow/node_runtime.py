...
class DifyRetrieverAttachmentLoader(RetrieverAttachmentLoaderProtocol):
    ...
    def __init__(
        self,
        *,
      ***REMOVED***le_reference_factory: FileReferenceFactoryProtocol,
        ...
        *,
        ...
        if self._is_workflow_tool_provider(node_data):
            outer_workflow_run_id = (
              ...
              ***REMOVED*** get_system_text(variable_pool, SystemVariableKey.WORKFLOW_EXECUTION_ID)
            )
...
def build_dify_llm_file_saver(
    *,
    ...
    return FileSaverImpl(
      ...
      ***REMOVED***le_reference_factory=DifyFileReferenceFactory(run_context),
