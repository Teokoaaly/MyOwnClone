...
class WorkflowResponseConverter:
    ...
    def workflow_finish_to_stream_response(
      ...
      ***REMOVED***nished_at = naive_utc_now()
        ...
        return WorkflowFinishStreamResponse(
            ...
            data=WorkflowFinishStreamResponse.Data(
                ...
                created_at=int(started_at.timestamp()),
              ***REMOVED***nished_at=int(finished_at.timestamp()),
              ***REMOVED***les=self.fetch_files_from_node_outputs(outputs_mapping),
    ...
    def workflow_run_result_to_finish_response(
      ...
      ***REMOVED***nished_at = workflow_run.finished_at
        ...
        return WorkflowFinishStreamResponse(
            ...
            data=WorkflowFinishStreamResponse.Data(
              ...
              ***REMOVED***nished_at=int(finished_at.timestamp()),
              ***REMOVED***les=cls.fetch_files_from_node_outputs(encoded_outputs),
    ...
    def workflow_node_finish_to_stream_response(
      ...
      ***REMOVED***nished_at = event.finished_at or naive_utc_now()
        ...
        return NodeFinishStreamResponse(
            ...
            data=NodeFinishStreamResponse.Data(
              ...
              ***REMOVED***nished_at=int(finished_at.timestamp()),
              ***REMOVED***les=self.fetch_files_from_node_outputs(event.outputs or {}),
                iteration_id=event.in_iteration_id,
                loop_id=event.in_loop_id,
            ),
        )
        ...
        *,
        ...
        return IterationNodeCompletedStreamResponse(
            ...
            data=IterationNodeCompletedStreamResponse.Data(
              ...
              ***REMOVED*** WorkflowNodeExecutionStatus.FAILED,
                error=None,
              ...
              ***REMOVED***nished_at=int(time.time()),
                steps=event.steps,
            ),
        )
    ...
    def fetch_files_from_node_outputs(cls, outputs_dict: Mapping[str, Any] | None) -> Sequence[Mapping[str, Any]]:
      ...
      ***REMOVED***les = [cls._fetch_files_from_variable_value(output_value) for output_value in outputs_dict.values()]
        # Remove None
      ***REMOVED***les = [file for file in files if file]
        # Flatten list
    ...
    def _fetch_files_from_variable_value(cls, value: Union[dict, list, Segment]) -> Sequence[Mapping[str, Any]]:
      ...
      ***REMOVED***les: list[Mapping[str, Any]] = []
        match value:
            case FileSegment():
              ***REMOVED***les.append(value.value.to_dict())
            case ArrayFileSegment():
              ***REMOVED***les.extend([i.to_dict() for i in value.value])
            case File():
              ***REMOVED***les.append(value.to_dict())
            case list():
                for item in value:
                  ***REMOVED***le = cls._get_file_var_from_value(item)
                    if file:
                      ***REMOVED***les.append(file)
            case dict():
              ***REMOVED***le = cls._get_file_var_from_value(value)
                if file:
                  ***REMOVED***les.append(file)
            case _:
                pass
