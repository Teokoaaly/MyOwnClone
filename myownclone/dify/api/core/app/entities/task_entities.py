...
class WorkflowTaskState(TaskState):
    ...
    answer: str = ""
  ***REMOVED***rst_token_time: float | None = None
...
class MessageEndStreamResponse(StreamResponse):
  ...
  ***REMOVED***les: Sequence[Mapping[str, Any]] | None = None
...
class WorkflowFinishStreamResponse(StreamResponse):
    ...
    class Data(BaseModel):
        ...
        created_at: int
      ***REMOVED***nished_at: int | None
        exceptions_count: int | None = 0
      ***REMOVED***les: Sequence[Mapping[str, Any]] | None = []
