...
class TraceTask:
    ...
    def workflow_trace(
      ...
      ***REMOVED***le_list = workflow_run_inputs.get("sys.file") or []
    ...
    def message_trace(self, message_id: str | None, **kwargs):
      ...
      ***REMOVED***le_list = []
        if message_file_data and message_file_data.url is not None:
          ***REMOVED***le_url = f"{self.file_base_url}/{message_file_data.url}" if message_file_data else ""
          ***REMOVED***le_list.append(file_url)
      ...
      ***REMOVED***:
        ...
        message_trace_info = MessageTraceInfo(
          ...
          ***REMOVED*** created_at + timedelta(seconds=message_data.provider_response_latency),
            metadata=metadata,
    ...
    def tool_trace(self, message_id, timer, **kwargs):
      ...
      ***REMOVED***le_url = ""
        ...
        if message_file_data:
          ...
          ***REMOVED***le_url = f"{self.file_base_url}/{message_file_data.url}"
...
class TraceQueueManager:
    ...
    def collect_tasks(self):
        ...
        while len(tasks) < trace_manager_batch_size and not trace_manager_queue.empty():
            ...
            tasks.append(task)
            trace_manager_queue.task_***REMOVED***()
        return tasks
    ...
    def send_to_celery(self, tasks: list[TraceTask]):
        with self.flask_app.app_context():
            for task in tasks:
              ...
              ***REMOVED***le_path = f"{OPS_FILE_PATH}{storage_id}/{file_id}.json"
