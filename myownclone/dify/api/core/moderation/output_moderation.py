...
class OutputModeration(BaseModel):
  ...
  ***REMOVED***nal_output: str | None = None
    ...
    def moderation_completion(self, completion: str, public_event: bool = False) -> tuple[str, bool]:
        ...
        if result.action == ModerationAction.DIRECT_OUTPUT:
          ***REMOVED***nal_output = result.preset_response
      ***REMOVED***:
          ***REMOVED***nal_output = result.text
    ...
    def worker(self, flask_app: Flask, buffer_size: int):
        with flask_app.app_context():
            ...
            while self.thread_running:
              ...
              ***REMOVED***:
                  ***REMOVED***nal_output = result.text + self.buffer[len(moderation_buffer) :]
