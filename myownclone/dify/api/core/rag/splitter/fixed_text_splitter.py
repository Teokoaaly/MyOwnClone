      ...
      ***REMOVED***nal_chunks = []
        ...
        for chunk, chunk_length in zip(chunks, chunks_lengths):
            if chunk_length > self._chunk_size:
              ***REMOVED***nal_chunks.extend(self.recursive_split_text(chunk))
          ***REMOVED***:
              ***REMOVED***nal_chunks.append(chunk)
    ...
    def recursive_split_text(self, text: str) -> list[str]:
            ...
            for s, s_len in zip(splits, s_lens):
              ...
              ***REMOVED***:
                    if _good_splits:
                      ...
                      ***REMOVED***nal_chunks.extend(merged_text)
                        _good_splits = []
                        _good_splits_lengths = []
                    if not new_separators:
                      ***REMOVED***nal_chunks.append(s)
                  ***REMOVED***:
                        other_info = self._split_text(s, new_separators)
                      ***REMOVED***nal_chunks.extend(other_info)
      ...
      ***REMOVED***:
            ...
            for s, s_len in zip(splits, s_lens):
              ...
              ***REMOVED***:
                  ***REMOVED***nal_chunks.append(current_part)
