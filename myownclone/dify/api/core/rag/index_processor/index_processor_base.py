    ...
    def _get_splitter(
        ...
        if processing_rule_mode in ["custom", "hierarchical"]:
            ...
            character_splitter = FixedRecursiveCharacterTextSplitter.from_encoder(
              ...
              ***REMOVED***xed_separator=separator,
                separators=["\n\n", "。", ". ", " ", ""],
          ...
          ***REMOVED***lename = None
            ...
            if content_disposition:
                ...
                if "filename" in params:
                  ***REMOVED***lename = params["filename"]
                  ***REMOVED***lename = unquote(filename)

            if not filename:
                parsed_url = urlparse(image_url)
                # Decode percent-encoded characters in the URL path.
                path = unquote(parsed_url.path)
              ***REMOVED***lename = os.path.basename(path)

            if not filename:
              ***REMOVED***lename = "downloaded_image_file"
            ...
            if not current_ext and real_ext or current_ext in [".php", ".jsp", ".asp", ".html"] and real_ext:
              ***REMOVED***lename = f"{name}{real_ext}"
