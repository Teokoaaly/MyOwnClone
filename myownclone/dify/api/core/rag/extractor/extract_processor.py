        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            if not suffix and suffix != ".":
              ...
              ***REMOVED***:
                  ...
                  ***REMOVED***lename_match = re.search(r'filename="([^"]+)"', content_disposition)
                    if filename_match:
                      ***REMOVED***lename = unquote(filename_match.group(1))
          ...
          ***REMOVED***le_path = f"{temp_dir}/{next(tempfile._get_candidate_names())}{suffix}"  # type: ignore
    ...
    def extract(
        ...
        if extract_setting.datasource_type == DatasourceType.FILE:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
              ...
              ***REMOVED***le_extension = input_file.suffix.lower()
                assert upload_file is not None, "upload_file is required"
                ...
                if etl_type == "Unstructured":
                    ...
                    if file_extension in {".xlsx", ".xls"}:
                        ...
                        extractor = (
                            ...
                            if is_automatic
                          ***REMOVED*** MarkdownExtractor(file_path, autodetect_encoding=True)
                        )
