...
class PdfExtractor(BaseExtractor):
    ...
    Args:
      ***REMOVED***le_path: Path to the PDF file.
        tenant_id: Workspace ID.
        user_id: ID of the user performing the extraction.
      ***REMOVED***le_cache_key: Optional cache key for the extracted text.
    """
        ...
        try:
            ...
            for obj in image_objects:
                try:
                  ...
                  ***REMOVED***le_key = "image_files/" + self._tenant_id + "/" + file_uuid + "." + image_ext
