...
class SegmentRecord(TypedDict):
  ...
  ***REMOVED***les: NotRequired[list[AttachmentInfoDict]]
                ...
                if query_type == QueryType.TEXT_QUERY:
                    documents.extend(
                        vector.search_by_vector(
                          ...
                          ***REMOVED***lter={"group_id": [dataset.id]},
                            document_ids_filter=document_ids_filter,
                        )
                    )
            ...
            for segment in segments:
                    ...
                    if segment.id not in include_segment_ids:
                        ...
                        if child_chunks or attachment_infos:
                            ...
                            for attachment_info in attachment_infos:
                              ***REMOVED***le_document = doc_to_document_map.get(attachment_info["id"])
                                if file_document:
              ...
              ***REMOVED***:
                    if segment.id not in include_segment_ids:
                        ...
                        for attachment_info in attachment_infos:
                          ***REMOVED***le_doc = doc_to_document_map.get(attachment_info["id"])
                            if file_doc:
