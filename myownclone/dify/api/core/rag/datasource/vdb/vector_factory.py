...
class Vector:
    ...
    def _filter_empty_text_documents(documents: list[Document]) -> list[Document]:
      ***REMOVED***ltered_documents = [document for document in documents if document.page_content.strip()]
              ...
              ***REMOVED***le_base64_list = []
                ...
                for document in batch:
                    ...
                    if upload_file:
                      ...
                      ***REMOVED***le_base64_str = base64.b64encode(blob).decode()
                      ***REMOVED***le_base64_list.append(
                            {
