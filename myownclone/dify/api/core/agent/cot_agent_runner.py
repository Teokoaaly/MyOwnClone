...
class CotAgentRunner(BaseAgentRunner, ABC):
      ...
      ***REMOVED***nal_answer = ""
        ...
        def increase_usage(final_llm_usage_dict: dict[str, LLMUsage | None], usage: LLMUsage):
            if not final_llm_usage_dict["usage"]:
              ***REMOVED***nal_llm_usage_dict["usage"] = usage
          ***REMOVED***:
                ...
                if scratchpad.action.action_name.lower() == "final answer":
                    ...
                    try:
                        if isinstance(scratchpad.action.action_input, dict):
                          ***REMOVED***nal_answer = json.dumps(scratchpad.action.action_input, ensure_ascii=False)
                        elif isinstance(scratchpad.action.action_input, str):
                          ***REMOVED***nal_answer = scratchpad.action.action_input
                      ***REMOVED***:
                          ***REMOVED***nal_answer = f"{scratchpad.action.action_input}"
                    except TypeError:
                      ***REMOVED***nal_answer = f"{scratchpad.action.action_input}"
              ***REMOVED***:
                    function_call_state = True
    ...
    def _fill_in_inputs_from_external_data_tools(self, instruction: str, inputs: Mapping[str, Any]) -> str:
        """
      ***REMOVED***ll in inputs from external data tools
        """
