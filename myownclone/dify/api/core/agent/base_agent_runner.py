...
class BaseAgentRunner(AppRunner):
    ...
    def organize_agent_user_prompt(self, message: Message) -> UserPromptMessage:
      ...
      ***REMOVED***les = db.session.scalars(stmt).all()
        if not files:
            return UserPromptMessage(content=message.query)
        if message.app_model_config:
          ***REMOVED***le_extra_config = FileUploadConfigManager.convert(message.app_model_config.to_dict())
      ***REMOVED***:
          ***REMOVED***le_extra_config = None
      ...
      ***REMOVED***le_objs = file_factory.build_from_message_files(
            message_files=files,
            tenant_id=self.tenant_id,
        ...
        for file in file_objs:
            prompt_message_contents.append(
              ***REMOVED***le_manager.to_prompt_message_content(
                  ***REMOVED***le,
