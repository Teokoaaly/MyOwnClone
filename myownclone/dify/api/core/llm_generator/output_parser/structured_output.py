...
def _handle_prompt_based_schema(
    ...
    system_prompt_content = (
      ...
      ***REMOVED*** structured_output_prompt
    )
    system_prompt = SystemPromptMessage(content=system_prompt_content)

    # Extract content from the last user message

  ***REMOVED***ltered_prompts = [prompt for prompt in prompt_messages if not isinstance(prompt, SystemPromptMessage)]
