...
class ToolFileManager:
    ...
    def _build_graph_file_reference(tool_file: ToolFile) -> File:
        ...
        return File(
          ***REMOVED***le_type=get_file_type_by_mime_type(tool_file.mimetype),
            transfer_method=FileTransferMethod.TOOL_FILE,
            remote_url=tool_file.original_url,
            reference=build_file_reference(record_id=str(tool_file.id)),
          ***REMOVED***lename=tool_file.name,
            extension=extension,
    ...
    def sign_file(tool_file_id: str, extension: str) -> str:
      ...
      ***REMOVED***le_preview_url = f"{base_url}/files/tools/{tool_file_id}{extension}"
    ...
    def create_file_by_raw(
      ...
      ***REMOVED***lepath = f"tools/{tenant_id}/{unique_filename}"
    ...
    def create_file_by_url(
      ...
      ***REMOVED***le_url: str,
        ...
        extension = guess_extension(mimetype) or ".bin"
        unique_name = uuid4().hex
      ***REMOVED***lename = f"{unique_name}{extension}"
      ***REMOVED***lepath = f"tools/{tenant_id}/{filename}"
