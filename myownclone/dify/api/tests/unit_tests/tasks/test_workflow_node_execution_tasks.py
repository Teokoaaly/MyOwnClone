...
#   ***REMOVED***le_service = Mock()
#     mock_upload_file = Mock(spec=UploadFile)
#     mock_upload_file.id = "mock-file-id"
#   ***REMOVED***le_service.upload_file.return_value = mock_upload_file
#     return file_service
...
#                   ***REMOVED***le_id=mock_upload_file.id,
#                 ),
#             }
...
#           ***REMOVED***le_service=mock_file_service,
#         )
...
#             node_execution_id="test-execution",
#             type_=ExecutionOffLoadType.OUTPUTS,
#           ***REMOVED***le_id="outputs-file-id",
#         )

#         result = _replace_or_append_offload([existing_offload], new_offload)

#         assert len(result) == 2
#       ***REMOVED***le_ids = [offload.file_id for offload in result]
