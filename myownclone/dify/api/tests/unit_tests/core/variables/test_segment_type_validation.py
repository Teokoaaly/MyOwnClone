...
def get_file_cases() -> list[ValidationTestCase]:
    ...
    image_file = create_test_file(
      ***REMOVED***le_type=FileType.IMAGE, filename="image.jpg", extension=".jpg", mime_type="image/jpeg"
    )
...
def get_array_file_validation_cases() -> list[ArrayValidationTestCase]:
  ...
  ***REMOVED***le1 = create_test_file(filename="file1.txt")
  ***REMOVED***le2 = create_test_file(filename="file2.txt")
