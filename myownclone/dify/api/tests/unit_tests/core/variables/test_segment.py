...
def create_test_file(
  ***REMOVED***le_type: FileType = FileType.DOCUMENT,
    transfer_method: FileTransferMethod = FileTransferMethod.LOCAL_FILE,
  ***REMOVED***lename: str = "test.txt",
    extension: str = ".txt",
...
class TestSegmentDumpAndLoad:
    ...
    def test_segment_discriminator_function_for_segment_types(self):
      ...
      ***REMOVED***le1 = create_test_file()
      ***REMOVED***le2 = create_test_file(filename="test2.txt")
...
class TestSegmentAdditionalProperties:
    ...
    def test_file_segment_properties(self):
      ...
      ***REMOVED***le = create_test_file(transfer_method=FileTransferMethod.REMOTE_URL, filename="doc.txt")
    ...
    def test_array_file_segment_markdown_and_empty_text_log(self):
      ...
      ***REMOVED***le1 = create_test_file(transfer_method=FileTransferMethod.REMOTE_URL, filename="a.txt")
      ***REMOVED***le2 = create_test_file(transfer_method=FileTransferMethod.REMOTE_URL, filename="b.txt")
...
class TestSegmentUtils:
    ...
    def test_file_segment_serialization(self):
      ***REMOVED***le = create_test_file(transfer_method=FileTransferMethod.REMOTE_URL, filename="single.txt")
