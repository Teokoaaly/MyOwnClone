...
class TestHtmlExtractor:
    def test_extract_returns_text_content(self, tmp_path):
      ***REMOVED***le_path = tmp_path / "sample.html"
      ***REMOVED***le_path.write_text("<html><body><h1>Title</h1><p>Hello</p></body></html>", encoding="utf-8")
    ...
    def test_load_as_text_strips_whitespace_and_handles_empty(self, tmp_path):
      ***REMOVED***le_path = tmp_path / "sample.html"
      ***REMOVED***le_path.write_text("<html><body>   \n  </body></html>", encoding="utf-8")
