...
def test_tool_in_chatflow():
  ...
  ***REMOVED***xture_data = runner.workflow_runner.load_fixture("chatflow_time_tool_static_output_workflow")
...
def test_answer_can_render_llm_structured_output_in_chatflow():
  ...
  ***REMOVED***xture_data = runner.workflow_runner.load_fixture("basic_chatflow")
