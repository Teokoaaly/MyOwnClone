...
def create_test_file_dict(
  ***REMOVED***lename: str = "test.jpg",
  ***REMOVED***le_type: str = "image",
...
def test_webhook_node_file_conversion_to_file_variable():
  ...
  ***REMOVED***le_dict = create_test_file_dict("uploaded_image.jpg")
...
def test_webhook_node_file_conversion_mixed_parameters():
  ...
  ***REMOVED***le_dict = create_test_file_dict("mixed_test.jpg")
