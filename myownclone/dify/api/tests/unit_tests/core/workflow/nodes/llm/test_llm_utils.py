...
def test_fetch_files_supports_known_segments_and_rejects_invalid_types():
  ***REMOVED***le = _build_image_file(file_id="image", related_id="image-related", remote_url="https://example.com/image.png")
    variable_pool = VariablePool.empty()
...
def test_handle_list_messages_supports_array_file_segments():
    variable_pool = VariablePool.empty()
  ***REMOVED***rst_file = _build_image_file(file_id="first", related_id="first-related", remote_url="https://example.com/1.png")
    second_file = _build_image_file(
      ***REMOVED***le_id="second",
  ...
  ***REMOVED***rst_prompt = ImagePromptMessageContent(
        format="png",
...
def test_append_file_prompts_merges_with_existing_user_content_or_appends_new_message():
  ***REMOVED***le = _build_image_file(file_id="image", related_id="image-related", remote_url="https://example.com/image.png")
  ***REMOVED***le_prompt = ImagePromptMessageContent(
        format="png",
        url="https://example.com/image.png",
        mime_type="image/png",
        detail=ImagePromptMessageContent.DETAIL.HIGH,
...
def test_fetch_prompt_messages_chat_mode_includes_query_memory_and_supported_files():
  ...
  ***REMOVED***le_prompts = [
    ...
    assert prompt_messages[2] == UserPromptMessage(
        content=[
          ***REMOVED***le_prompts[1],
          ***REMOVED***le_prompts[0],
