...
def _build_generate_entity(app_config, file_upload_config=None):
    ...
    return SimpleNamespace(
      ...
      ***REMOVED***les=[],
      ***REMOVED***le_upload_config=file_upload_config,
        stream=True,
        user_id="user",
...
class TestCompletionAppRunner:
    ...
    def test_run_dataset_and_external_tools_flow(self, runner, mocker: MockerFixture):
      ...
      ***REMOVED***le_upload_config = MagicMock()
      ***REMOVED***le_upload_config.image_config.detail = ImagePromptMessageContent.DETAIL.HIGH
