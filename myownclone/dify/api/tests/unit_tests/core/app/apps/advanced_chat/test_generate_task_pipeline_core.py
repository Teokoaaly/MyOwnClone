...
class TestAdvancedChatGenerateTaskPipeline:
    ...
    def test_to_blocking_response_returns_message_end(self):
        pipeline = _make_pipeline()
        pipeline._task_state.answer = "***REMOVED***"
        ...
        assert response.data.answer == "***REMOVED***"
    ...
    def test_iteration_and_loop_handlers(self):
        ...
        assert list(pipeline._handle_iteration_completed_event(iter_***REMOVED***)) == ["iter_***REMOVED***"]
