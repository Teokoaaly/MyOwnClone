...
class TestWorkflowGenerateTaskPipeline:
    ...
    def test_handle_node_succeeded_event_saves_output(self):
        pipeline = _make_pipeline()
        pipeline._workflow_response_converter.workflow_node_finish_to_stream_response = lambda **kwargs: "***REMOVED***"
    ...
    def test_dispatch_event_handles_node_failed(self):
        ...
        assert list(pipeline._dispatch_event(event)) == ["***REMOVED***"]
    ...
    def test_iteration_loop_and_human_input_handlers(self):
        ...
        pipeline._workflow_response_converter.workflow_iteration_completed_to_stream_response = lambda **kwargs: "***REMOVED***"
        ...
        pipeline._workflow_response_converter.workflow_loop_completed_to_stream_response = lambda **kwargs: "loop_***REMOVED***"
        ...
        iter_***REMOVED*** = QueueIterationCompletedEvent(
            node_execution_id="exec",
            node_id="node",
            node_type=BuiltinNodeTypes.LLM,
            node_title="LLM",
        ...
        loop_***REMOVED*** = QueueLoopCompletedEvent(
            node_execution_id="exec",
            node_id="node",
            node_type=BuiltinNodeTypes.LLM,
            node_title="LLM",
      ...
      ***REMOVED***lled_event = QueueHumanInputFormFilledEvent(
            node_execution_id="exec",
            node_id="node",
            node_type=BuiltinNodeTypes.LLM,
            node_title="title",
        ...
        assert list(pipeline._handle_iteration_completed_event(iter_***REMOVED***)) == ["***REMOVED***"]
        ...
        assert list(pipeline._handle_loop_completed_event(loop_***REMOVED***)) == ["loop_***REMOVED***"]
