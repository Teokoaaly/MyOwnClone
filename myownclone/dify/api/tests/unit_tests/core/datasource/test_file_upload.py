...
class TestFileSizeLimiting:
    ...
    def test_is_file_size_within_limit_image(self):
        ...
        def check_size(extension: str, file_size: int) -> bool:
            ...
            Args:
              ...
              ***REMOVED***le_size: Size of file in bytes
            ...
            if extension in IMAGE_EXTENSIONS:
              ***REMOVED***le_size_limit = dify_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024  # Convert MB to bytes
            elif extension in VIDEO_EXTENSIONS:
              ***REMOVED***le_size_limit = dify_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT * 1024 * 1024
            elif extension in AUDIO_EXTENSIONS:
              ***REMOVED***le_size_limit = dify_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT * 1024 * 1024
          ***REMOVED***:
                # Default limit for general files (documents, etc.)
              ***REMOVED***le_size_limit = dify_config.UPLOAD_FILE_SIZE_LIMIT * 1024 * 1024
    ...
    def test_is_file_size_within_limit_video(self):
        ...
        def check_size(extension: str, file_size: int) -> bool:
            if extension in IMAGE_EXTENSIONS:
              ***REMOVED***le_size_limit = dify_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024
            elif extension in VIDEO_EXTENSIONS:
              ***REMOVED***le_size_limit = dify_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT * 1024 * 1024
            elif extension in AUDIO_EXTENSIONS:
              ***REMOVED***le_size_limit = dify_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT * 1024 * 1024
...
class TestStoragePathGeneration:
    ...
    def test_storage_path_format(self):
      ...
      ***REMOVED***le_uuid = str(uuid.uuid4())
        extension = "txt"

        # Act
      ***REMOVED***le_key = f"upload_files/{tenant_id}/{file_uuid}.{extension}"
...
class TestInvalidFilenameHandling:
    ...
    def test_filename_contains_invalid_characters(self, invalid_char):
      ...
      ***REMOVED***lename = f"test{invalid_char}file.txt"
        invalid_chars = ["/", "\\"]
    ...
    def test_valid_filename_no_invalid_characters(self):
        ...
        # Arrange
      ***REMOVED***lename = "valid_file-name_123.txt"
        invalid_chars = ["/", "\\"]
    ...
    def test_filename_allows_safe_metadata_characters(self, safe_char):
      ...
      ***REMOVED***lename = f"candidate{safe_char}resume.txt"
        invalid_chars = ["/", "\\"]
    ...
    def test_extremely_long_filename_truncation(self):
        ...
        # Arrange
        long_name = "a" * 250
      ***REMOVED***lename = f"{long_name}.txt"
        extension = "txt"
        max_length = 200
...
class TestSourceUrlGeneration:
    ...
    def test_custom_source_url_preservation(self):
        ...
        # Act
      ***REMOVED***nal_url = custom_url or default_url
...
class TestFilenameValidation:
    ...
    def test_filename_with_spaces(self):
        ...
        # Arrange
      ***REMOVED***lename = "my document with spaces.pdf"
        invalid_chars = ["/", "\\"]
    ...
    def test_filename_length_boundary_cases(self):
        ...
        for name_length, should_truncate in test_cases:
          ...
          ***REMOVED***lename = f"{base_name}.txt"
            extension = "txt"
...
class TestMimeTypeHandling:
    ...
    def test_mime_type_category_mapping(self, extension, expected_mime_prefix):
      ...
      ***REMOVED***le extensions, ensuring proper content type handling.
        """
...
class TestFileHashingConsistency:
    ...
    def test_hash_algorithm_sha3_256(self):
        ...
        # Act - Generate hash
      ***REMOVED***le_hash = hashlib.sha3_256(content).hexdigest()
    ...
    def test_hash_binary_content_handling(self):
        ...
        # Act - Generate hash
      ***REMOVED***le_hash = hashlib.sha3_256(binary_content).hexdigest()
    ...
    def test_hash_empty_content(self):
        ...
        # Act - Generate hash
      ***REMOVED***le_hash = hashlib.sha3_256(empty_content).hexdigest()
