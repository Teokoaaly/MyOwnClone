...
class TestOrganizeUserQuery:
    ...
    def test_with_files_uses_image_detail_config(self, runner, mocker: MockerFixture):
      ***REMOVED***le_content = TextPromptMessageContent(data="file-content")
...
class TestRunMethod:
    ...
    def test_run_streaming_tool_calls_list_content(self, runner):
      ...
      ***REMOVED***nal_message = DummyMessage(content="***REMOVED***", tool_calls=[])
      ***REMOVED***nal_result = DummyResult(message=final_message, usage=build_usage())
    ...
    def test_run_with_tool_instance_and_files(self, runner, mocker: MockerFixture):
        ...
        dummy_message = DummyMessage(content="", tool_calls=[tool_call])
        result = DummyResult(message=dummy_message, usage=build_usage())
      ***REMOVED***nal_result = DummyResult(message=DummyMessage(content="***REMOVED***", tool_calls=[]), usage=build_usage())
