...
def _validate(
    *,
    input_file_type: str,
  ***REMOVED***le_extension: str = ".png",
  ***REMOVED***le_transfer_method: FileTransferMethod = FileTransferMethod.LOCAL_FILE,
    config: FileUploadConfig,
) -> bool:
    return is_file_valid_with_config(
        input_file_type=input_file_type,
      ***REMOVED***le_extension=file_extension,
      ***REMOVED***le_transfer_method=file_transfer_method,
        config=config,
    )
...
def test_tool_file_always_passes():
    ...
    assert (
        _validate(
          ...
          ***REMOVED***le_extension=".png",
          ***REMOVED***le_transfer_method=FileTransferMethod.TOOL_FILE,
            config=config,
        )
        is True
    )
...
def test_transfer_method_gate_for_non_image():
    ...
    assert (
        _validate(
          ...
          ***REMOVED***le_extension=".pdf",
          ***REMOVED***le_transfer_method=FileTransferMethod.LOCAL_FILE,
            config=config,
        )
        is True
    )
    assert (
        _validate(
            input_file_type="document",
          ***REMOVED***le_extension=".pdf",
          ***REMOVED***le_transfer_method=FileTransferMethod.REMOTE_URL,
            config=config,
        )
        is False
    )
