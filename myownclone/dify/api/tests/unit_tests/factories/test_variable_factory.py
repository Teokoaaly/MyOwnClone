...
def test_build_segment_file_array_with_different_file_types():
    ...
    video_file = File(
      ***REMOVED***le_id="video_id",
        tenant_id="test_tenant_id",
      ***REMOVED***le_type=FileType.VIDEO,
        transfer_method=FileTransferMethod.LOCAL_FILE,
        related_id="video_relation_id",
      ***REMOVED***lename="video",
        extension=".mp4",
        mime_type="video/mp4",
        size=5000,
    )
    ...
    audio_file = File(
      ***REMOVED***le_id="audio_id",
        tenant_id="test_tenant_id",
      ***REMOVED***le_type=FileType.AUDIO,
        transfer_method=FileTransferMethod.LOCAL_FILE,
        related_id="audio_relation_id",
      ***REMOVED***lename="audio",
        extension=".mp3",
...
def _generate_file(draw) -> File:
  ***REMOVED***le_type, mime_type, extension = draw(
        st.sampled_from(
            [
