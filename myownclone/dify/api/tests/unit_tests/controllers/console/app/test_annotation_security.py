...
class TestAnnotationImportFileValidation:
    ...
    def test_file_size_limit_enforced(self):
      ...
      ***REMOVED***le = FileStorage(stream=io.BytesIO(large_content), filename="test.csv", content_type="text/csv")
    ...
    def test_empty_file_rejected(self):
      ...
      ***REMOVED***le = FileStorage(stream=io.BytesIO(b""), filename="test.csv", content_type="text/csv")
    ...
    def test_non_csv_file_rejected(self):
      ...
      ***REMOVED***le = FileStorage(stream=io.BytesIO(b"test"), filename="test.txt", content_type="text/plain")
...
class TestAnnotationImportServiceValidation:
    ...
    def test_max_records_limit_enforced(self, mock_app, mock_db_session):
      ...
      ***REMOVED***le = FileStorage(stream=io.BytesIO(csv_content.encode()), filename="test.csv", content_type="text/csv")
