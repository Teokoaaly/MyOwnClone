...
class TestOpenApiWorkflowEventsApi:
    ...
    def test_finished_run_returns_single_sse_event(self, app, bypass_pipeline, monkeypatch):
        """A finished run returns a single ***REMOVED***-event SSE response without streaming."""
        from datetime import UTC, datetime

        module = sys.modules["controllers.openapi.workflow_events"]
      ***REMOVED***nished_at = datetime(2024, 1, 1, tzinfo=UTC)
      ...
      ***REMOVED***nish_response = SimpleNamespace(
