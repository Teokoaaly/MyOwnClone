...
class DocumentValidationTestDataFactory:
    ...
    def create_data_source_mock(
      ...
      ***REMOVED***le_ids: list[str] | None = None,
        ...
        Args:
          ...
          ***REMOVED***le_ids: List of file IDs for upload_file type
        ...
        if data_source_type == "upload_file":
          ***REMOVED***le_info = Mock(spec=FileInfo)
          ***REMOVED***le_info.file_ids = file_ids or ["file-123"]
