    ...
    def create_file_storage_mock(
      ***REMOVED***lename: str = "test.mp3",
        ...
        **kwargs,
        ...
        Args:
          ***REMOVED***lename: Name of the file
        ...
        """
      ***REMOVED***le = Mock(spec=FileStorage)
      ***REMOVED***le.filename = filename
      ***REMOVED***le.mimetype = mimetype
      ***REMOVED***le.stream = Mock()
      ***REMOVED***le.stream.read = Mock(return_value=content)
        for key, value in kwargs.items():
...
class TestAudioServiceASR:
    ...
    def test_transcript_asr_success_chat_mode(self, mock_model_manager_class, factory: AudioServiceTestDataFactory):
      ...
      ***REMOVED***le = factory.create_file_storage_mock()
    ...
    def test_transcript_asr_raises_error_for_unsupported_audio_type(self, factory: AudioServiceTestDataFactory):
      ...
      ***REMOVED***le = factory.create_file_storage_mock(mimetype="video/mp4")
    ...
    def test_transcript_asr_raises_error_for_large_file(self, factory: AudioServiceTestDataFactory):
      ...
      ***REMOVED***le = factory.create_file_storage_mock(content=large_content)
