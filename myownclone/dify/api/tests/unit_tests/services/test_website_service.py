...
def test_crawl_url_dispatches_by_provider(monkeypatch: pytest.MonkeyPatch) -> None:
  ...
  ***REMOVED***recrawl_mock = MagicMock(return_value={"status": "active", "job_id": "j1"})
  ...
  ***REMOVED***recrawl_mock.assert_called_once()
...
def test_crawl_with_firecrawl_builds_params_single_page_and_sets_redis(monkeypatch: pytest.MonkeyPatch) -> None:
  ***REMOVED***recrawl_instance = MagicMock(name="FirecrawlApp-instance")
  ***REMOVED***recrawl_instance.crawl_url.return_value = "job-1"
  ***REMOVED***recrawl_cls = MagicMock(return_value=firecrawl_instance)
  ...
  ***REMOVED***xed_now = datetime(2024, 1, 1, tzinfo=UTC)
  ...
  ***REMOVED***recrawl_cls.assert_called_once_with(api_key="k", base_url="b")
  ***REMOVED***recrawl_instance.crawl_url.assert_called_once()
...
def test_crawl_with_firecrawl_builds_params_multi_page_including_prompt(monkeypatch: pytest.MonkeyPatch) -> None:
  ***REMOVED***recrawl_instance = MagicMock(name="FirecrawlApp-instance")
  ***REMOVED***recrawl_instance.crawl_url.return_value = "job-2"
...
def test_get_crawl_status_dispatches(monkeypatch: pytest.MonkeyPatch) -> None:
    monkeypatch.setattr(WebsiteService, "_get_credentials_and_config", MagicMock(return_value=("k", {"base_url": "b"})))
  ***REMOVED***recrawl_status = MagicMock(return_value={"status": "active"})
  ...
  ***REMOVED***recrawl_status.assert_called_once_with("job-1", "k", {"base_url": "b"})
...
def test_get_firecrawl_status_adds_time_consuming_when_completed_and_cached(monkeypatch: pytest.MonkeyPatch) -> None:
  ***REMOVED***recrawl_instance = MagicMock()
  ***REMOVED***recrawl_instance.check_crawl_status.return_value = {"status": "completed", "total": 2, "current": 2, "data": []}
    monkeypatch.setattr(website_service_module, "FirecrawlApp", MagicMock(return_value=firecrawl_instance))
...
def test_get_firecrawl_status_completed_without_cache_does_not_add_time(monkeypatch: pytest.MonkeyPatch) -> None:
  ***REMOVED***recrawl_instance = MagicMock()
  ***REMOVED***recrawl_instance.check_crawl_status.return_value = {"status": "completed", "total": 1, "current": 1, "data": []}
    monkeypatch.setattr(website_service_module, "FirecrawlApp", MagicMock(return_value=firecrawl_instance))
...
def test_get_firecrawl_url_data_raises_when_job_not_completed(monkeypatch: pytest.MonkeyPatch) -> None:
  ...
  ***REMOVED***recrawl_instance = MagicMock()
  ***REMOVED***recrawl_instance.check_crawl_status.return_value = {"status": "active"}
    monkeypatch.setattr(website_service_module, "FirecrawlApp", MagicMock(return_value=firecrawl_instance))
...
def test_get_firecrawl_url_data_returns_none_when_not_found(monkeypatch: pytest.MonkeyPatch) -> None:
  ...
  ***REMOVED***recrawl_instance = MagicMock()
  ***REMOVED***recrawl_instance.check_crawl_status.return_value = {"status": "completed", "data": [{"source_url": "x"}]}
    monkeypatch.setattr(website_service_module, "FirecrawlApp", MagicMock(return_value=firecrawl_instance))
...
def test_scrape_with_firecrawl_calls_app(monkeypatch: pytest.MonkeyPatch) -> None:
  ***REMOVED***recrawl_instance = MagicMock()
  ***REMOVED***recrawl_instance.scrape_url.return_value = {"markdown": "m"}
    monkeypatch.setattr(website_service_module, "FirecrawlApp", MagicMock(return_value=firecrawl_instance))
  ...
  ***REMOVED***recrawl_instance.scrape_url.assert_called_once_with(url="u", params={"onlyMainContent": True})
