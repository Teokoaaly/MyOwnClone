...
def test_upload_invoke_entities_returns_file_id(mocker, proxy) -> None:
  ...
  ***REMOVED***le_service_cls = mocker.patch("services.rag_pipeline.rag_pipeline_task_proxy.FileService")
  ***REMOVED***le_service_cls.return_value.upload_text.return_value = upload_file
  ...
  ***REMOVED***le_service_cls.return_value.upload_text.assert_called_once()
