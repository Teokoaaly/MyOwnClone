...
class TestWebhookServiceUnit:
    ...
    def test_extract_webhook_data_multipart_with_files(self):
        ...
        # Create a mock file
      ***REMOVED***le_content = b"test file content"
      ***REMOVED***le_storage = FileStorage(stream=BytesIO(file_content), filename="test.txt", content_type="text/plain")
    ...
    def test_process_file_uploads_success(self, mock_file_factory, mock_tool_file_manager):
      ...
      ***REMOVED***les = {
        ...
        # Mock file reads
      ***REMOVED***les["file1"].stream.read.return_value = b"content1"
      ***REMOVED***les["file2"].stream.read.return_value = b"content2"
    ...
    def test_process_file_uploads_with_errors(self, mock_file_factory, mock_tool_file_manager):
      ...
      ***REMOVED***les["good_file"].stream.read.return_value = b"content"
      ***REMOVED***les["bad_file"].stream.read.side_effect = Exception("Read error")
