    ...
    def test_get_default_block_config_http_request_uses_passed_config(self, workflow_service):
        ...
        with (
            ...
            result = workflow_service.get_default_block_config(
              ...
              ***REMOVED***lters={HTTP_REQUEST_CONFIG_FILTER_KEY: provided_config},
            )
        ...
        with (
            ...
            with pytest.raises(TypeError, match="http_request_config must be an HttpRequestNodeConfig instance"):
                workflow_service.get_default_block_config(
                    BuiltinNodeTypes.HTTP_REQUEST,
                  ***REMOVED***lters={HTTP_REQUEST_CONFIG_FILTER_KEY: "invalid"},
                )
...
class TestRebuildFileForUserInputsInStartNode:
    ...
    def test_rebuild_should_rebuild_file_variable(
        ...
        # Arrange
      ***REMOVED***le_var = self._make_variable("attachment", VariableEntityType.FILE)
        start_data = self._make_start_node_data([file_var])
      ***REMOVED***le_value = {"url": "https://example.com/file.pdf"}
    ...
    def test_build_human_input_node(self, service: WorkflowService) -> None:
        ...
        with (
            ...
            mock_node_cls.assert_called_once_with(
              ...
              ***REMOVED***le_reference_factory=mock_file_reference_factory_cls.return_value,
