...
def test_legacy_model_type_migration_end_to_end_across_supported_backends(
  ...
  ***REMOVED***xture = seed_legacy_model_type_dirty_data(engine)
  ...
  ***REMOVED***rst_apply_state = {
    ...
    assert credential_ids == {
      ***REMOVED***xture.primary.winner_credential_id,
      ***REMOVED***xture.primary.distinct_credential_id,
    }
    lb_row = next(
        row
...
def test_load_balancing_inherit_deduplication_is_applied_consistently_across_supported_backends(
  ...
  ***REMOVED***xture = seed_legacy_model_type_dirty_data(engine)
    ...
    assert dry_run_row_updates == {
      ***REMOVED***xture.primary.load_balancing_config_id,
