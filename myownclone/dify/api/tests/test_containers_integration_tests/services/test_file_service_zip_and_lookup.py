...
def test_get_upload_files_by_ids_returns_id_keyed_mapping(db_session_with_containers: Session) -> None:
    ...
    tenant_id = str(uuid4())
  ***REMOVED***le1 = _create_upload_file(db_session_with_containers, tenant_id=tenant_id, key="k1", name="file1.txt")
  ***REMOVED***le2 = _create_upload_file(db_session_with_containers, tenant_id=tenant_id, key="k2", name="file2.txt")
...
def test_get_upload_files_by_ids_filters_by_tenant(db_session_with_containers: Session) -> None:
    ...
    tenant_a = str(uuid4())
    tenant_b = str(uuid4())
  ***REMOVED***le_a = _create_upload_file(db_session_with_containers, tenant_id=tenant_a, key="ka", name="a.txt")
