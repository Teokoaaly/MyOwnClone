...
class TestMetadataService:
    ...
    def test_create_metadata_name_already_exists(
      ...
      ***REMOVED***rst_metadata_args = MetadataArgs(type=DatasetMetadataType.STRING, name="duplicate_name")
    ...
    def test_update_metadata_name_already_exists(
      ...
      ***REMOVED***rst_metadata_args = MetadataArgs(type=DatasetMetadataType.STRING, name="first_metadata")
      ***REMOVED***rst_metadata = MetadataService.create_metadata(dataset.id, first_metadata_args)
    ...
    def test_get_built_in_fields_success(self, db_session_with_containers: Session, mock_external_service_dependencies):
      ...
      ***REMOVED***eld_names = [field["name"] for field in result]
      ***REMOVED***eld_types = [field["type"] for field in result]
