...
class TestFileService:
    ...
    def test_upload_file_success(self, db_session_with_containers: Session, engine, mock_external_service_dependencies):
      ...
      ***REMOVED***lename = "test_document.pdf"
    ...
    def test_upload_file_invalid_filename_characters(
      ...
      ***REMOVED***lename = "test/file<name>.txt"
    ...
    def test_upload_file_allows_regular_punctuation_in_filename(
      ...
      ***REMOVED***lename = 'candidate?resume for "dify"<final>|v2:.txt'
        content = b"test content"
        mimetype = "text/plain"
    ...
    def test_upload_file_too_large(
      ...
      ***REMOVED***lename = "large_image.jpg"
    ...
    def test_is_file_size_within_limit_image_success(
        ...
        """
        extension = "jpg"
      ***REMOVED***le_size = dify_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024  # Exactly at limit
    ...
    def test_is_file_size_within_limit_video_success(
        ...
        """
        extension = "mp4"
      ***REMOVED***le_size = dify_config.UPLOAD_VIDEO_FILE_SIZE_LIMIT * 1024 * 1024  # Exactly at limit
    ...
    def test_is_file_size_within_limit_audio_success(
        ...
        """
        extension = "mp3"
      ***REMOVED***le_size = dify_config.UPLOAD_AUDIO_FILE_SIZE_LIMIT * 1024 * 1024  # Exactly at limit
    ...
    def test_is_file_size_within_limit_document_success(
        ...
        """
        extension = "pdf"
      ***REMOVED***le_size = dify_config.UPLOAD_FILE_SIZE_LIMIT * 1024 * 1024  # Exactly at limit
    ...
    def test_is_file_size_within_limit_image_exceeded(
        ...
        """
        extension = "jpg"
      ***REMOVED***le_size = dify_config.UPLOAD_IMAGE_FILE_SIZE_LIMIT * 1024 * 1024 + 1  # Exceeds limit
    ...
    def test_is_file_size_within_limit_unknown_extension(
        ...
        """
        extension = "xyz"
      ***REMOVED***le_size = dify_config.UPLOAD_FILE_SIZE_LIMIT * 1024 * 1024  # Uses default limit
    ...
    def test_upload_file_special_characters_in_name(
      ...
      ***REMOVED***lename = "test-file_with_underscores_and.dots.txt"
        content = b"test content"
        mimetype = "text/plain"
    ...
    def test_file_size_limits_edge_cases(
        ...
        for extension, limit_config in [
          ...
          ***REMOVED***le_size = limit_config * 1024 * 1024
            result = FileService(engine).is_file_size_within_limit(extension=extension, file_size=file_size)
            assert result is True

            # Test one byte over limit
          ***REMOVED***le_size = limit_config * 1024 * 1024 + 1
            result = FileService(engine).is_file_size_within_limit(extension=extension, file_size=file_size)
            assert result is False
