...
class TestStorageKeyLoader:
    ...
    def _create_tool_file(
      ...
      ***REMOVED***le_key: str | None = None,
        ...
        tool_file = ToolFile(
          ...
          ***REMOVED***le_key=file_key or f"test_file_key_{uuid4()}",
            mimetype="text/plain",
    ...
    def _create_file(
        ...
        *,
        ...
        return File(
          ***REMOVED***le_id=str(uuid4()),
            tenant_id=override_tenant_id if override_tenant_id is not None else tenant_id,
          ***REMOVED***le_type=FileType.DOCUMENT,
            transfer_method=transfer_method,
            related_id=related_id,
            remote_url=remote_url,
          ***REMOVED***lename="test_file.txt",
            extension=".txt",
            mime_type="text/plain",
            size=1024,
    ...
    def test_load_storage_keys_local_file(self, db_session_with_containers: Session):
      ...
      ***REMOVED***le = self._create_file(tenant_id, related_id=upload_file.id, transfer_method=FileTransferMethod.LOCAL_FILE)
    ...
    def test_load_storage_keys_remote_url(self, db_session_with_containers: Session):
        ...
        upload_file = self._create_upload_file(db_session_with_containers, tenant_id, user_id)
      ***REMOVED***le = self._create_file(tenant_id, related_id=upload_file.id, transfer_method=FileTransferMethod.REMOTE_URL)
    ...
    def test_load_storage_keys_tool_file(self, db_session_with_containers: Session):
      ...
      ***REMOVED***le = self._create_file(tenant_id, related_id=tool_file.id, transfer_method=FileTransferMethod.TOOL_FILE)
    ...
    def test_load_storage_keys_mixed_methods(self, db_session_with_containers: Session):
      ...
      ***REMOVED***le1 = self._create_file(tenant_id, related_id=upload_file1.id, transfer_method=FileTransferMethod.LOCAL_FILE)
      ***REMOVED***le2 = self._create_file(tenant_id, related_id=upload_file2.id, transfer_method=FileTransferMethod.REMOTE_URL)
      ***REMOVED***le3 = self._create_file(tenant_id, related_id=tool_file.id, transfer_method=FileTransferMethod.TOOL_FILE)
    ...
    def test_load_storage_keys_nonexistent_upload_file_records(self, db_session_with_containers: Session):
        ...
        tenant_id = str(uuid4())
      ***REMOVED***le = self._create_file(tenant_id, related_id=str(uuid4()), transfer_method=FileTransferMethod.LOCAL_FILE)
    ...
    def test_load_storage_keys_nonexistent_tool_file_records(self, db_session_with_containers: Session):
        ...
        tenant_id = str(uuid4())
      ***REMOVED***le = self._create_file(tenant_id, related_id=str(uuid4()), transfer_method=FileTransferMethod.TOOL_FILE)
    ...
    def test_load_storage_keys_invalid_uuid(self, db_session_with_containers: Session):
        ...
        upload_file = self._create_upload_file(db_session_with_containers, tenant_id, user_id)
      ***REMOVED***le = self._create_file(tenant_id, related_id=upload_file.id, transfer_method=FileTransferMethod.LOCAL_FILE)
      ***REMOVED***le.related_id = "invalid-uuid-format"
    ...
    def test_load_storage_keys_tenant_isolation(self, db_session_with_containers: Session):
      ...
      ***REMOVED***le_current = self._create_file(
      ...
      ***REMOVED***le_other = self._create_file(
            tenant_id,
    ...
    def test_load_storage_keys_duplicate_file_ids(self, db_session_with_containers: Session):
        ...
        upload_file = self._create_upload_file(db_session_with_containers, tenant_id, user_id)
      ***REMOVED***le1 = self._create_file(tenant_id, related_id=upload_file.id, transfer_method=FileTransferMethod.LOCAL_FILE)
      ***REMOVED***le2 = self._create_file(tenant_id, related_id=upload_file.id, transfer_method=FileTransferMethod.LOCAL_FILE)
