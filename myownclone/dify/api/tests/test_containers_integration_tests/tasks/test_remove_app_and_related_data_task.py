...
def _create_draft_variables(
    ...
    *,
    app_id: str,
    count: int,
  ***REMOVED***le_id_by_index: dict[int, str] | None = None,
) -> list[WorkflowDraftVariable]:
    variables: list[WorkflowDraftVariable] = []
  ***REMOVED***le_id_by_index = file_id_by_index or {}
    ...
    for i in range(count):
        variable = WorkflowDraftVariable.new_node_variable(
          ...
          ***REMOVED***le_id=file_id_by_index.get(i),
        )
...
class TestDeleteDraftVariablesBatch:
    ...
    def test_delete_draft_variables_batch_logs_progress(
      ...
      ***REMOVED***le_ids = [variable_file.id for variable_file in offload_data["variable_files"]]
      ***REMOVED***le_id_by_index: dict[int, str] = {}
        for i in range(30):
            if i % 3 == 0:
              ***REMOVED***le_id_by_index[i] = file_ids[i // 3]
