...
class TestRagPipelineRunTasks:
    ...
    def test_priority_rag_pipeline_run_task_success(
      ...
      ***REMOVED***le_content = self._create_file_content_for_entities(entities)
    ...
    def test_rag_pipeline_run_task_legacy_compatibility(
      ...
      ***REMOVED***le_id = str(uuid.uuid4())
        ...
        with patch("tasks.rag_pipeline.rag_pipeline_run_task.group") as mock_group:
          ...
          ***REMOVED***rst_kwargs = jobs[0].kwargs if jobs else {}
    ...
    def test_priority_rag_pipeline_run_task_tenant_isolation(
      ...
      ***REMOVED***le_content1 = self._create_file_content_for_entities(entities1)
      ***REMOVED***le_content2 = self._create_file_content_for_entities(entities2)

        # Mock file service
      ***REMOVED***le_id1 = str(uuid.uuid4())
      ***REMOVED***le_id2 = str(uuid.uuid4())
