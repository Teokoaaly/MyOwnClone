...
def process_trace_tasks(self, file_info):
  ...
  ***REMOVED***le_id = file_info.get("file_id")
  ***REMOVED***le_path = f"{OPS_FILE_PATH}{app_id}/{file_id}.json"
  ***REMOVED***le_data = json.loads(storage.load(file_path))
    ...
    try:
        ...
        if is_ee_telemetry_enabled() and not enterprise_trace_dispatched:
          ...
          ***REMOVED***:
              ***REMOVED***le_data["_enterprise_trace_dispatched"] = True
