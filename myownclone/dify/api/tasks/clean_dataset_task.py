                    ...
                    if document.data_source_type == "upload_file":
                        if document.data_source_info:
                            ...
                            if data_source_info and "upload_file_id" in data_source_info:
                              ...
                              ***REMOVED***le_ids.append(file_id)
              ***REMOVED***les = session.scalars(select(UploadFile).where(UploadFile.id.in_(file_ids))).all()
                for file in files:
                    storage.delete(file.key)

              ***REMOVED***le_delete_stmt = delete(UploadFile).where(UploadFile.id.in_(file_ids))
