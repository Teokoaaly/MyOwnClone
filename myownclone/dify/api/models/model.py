...
class AppModelConfigDict(TypedDict):
  ...
  ***REMOVED***le_upload: FileUploadConfig
...
class AppModelConfig(TypeBase):
  ...
  ***REMOVED***le_upload: Mapped[str | None] = mapped_column(LongText, default=None)
    ...
    def sensitive_word_avoidance_dict(self) -> SensitiveWordAvoidanceConfig:
        return cast(
          ...
          ***REMOVED*** {"enabled": False, "type": "", "config": {}},
        )
    ...
    def agent_mode_dict(self) -> AgentModeConfig:
        return cast(
            ...
            if self.agent_mode
          ***REMOVED*** {"enabled": False, "strategy": None, "tools": [], "prompt": None},
        )
...
class Conversation(Base):
    ...
    def summary_or_query(self):
        if self.summary:
            return self.summary
      ***REMOVED***:
          ***REMOVED***rst_message = self.first_message
            if first_message:
        ...
        for message_file in message_files:
            match message_file.transfer_method:
                case FileTransferMethod.LOCAL_FILE:
                  ...
                  ***REMOVED***le = file_factory.build_from_mapping(
                        mapping={
                            "id": message_file.id,
