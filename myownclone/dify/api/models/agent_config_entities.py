...
class AgentSoulSkillsFilesConfig(BaseModel):
  ***REMOVED***les: list[dict[str, Any]] = Field(default_factory=list)
...
class AgentSoulDifyToolCredentialRef(BaseModel):
  ...
  ***REMOVED***eld is accepted by :class:`AgentSoulDifyToolConfig` and normalized here so
...
class DeclaredOutputConfig(BaseModel):
    ...
    description: str | None = None
    required: bool = True
  ***REMOVED***le: DeclaredOutputFileConfig | None = None
