...
class WorkflowService:
    ...
    def run_draft_workflow_node(
        ...
        account: Account,
        query: str = "",
      ***REMOVED***les: Sequence[File] | None = None,
...
def _rebuild_file_for_user_inputs_in_start_node(
    ...
    for variable in start_node_data.variables:
      ...
      ***REMOVED***le = _rebuild_single_file(tenant_id=tenant_id, value=value, variable_entity_type=variable.type)
