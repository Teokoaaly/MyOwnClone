...
class WorkflowConverter:
    ...
    def convert_app_model_config_to_workflow(self, app_model: App, app_model_config: AppModelConfig, account_id: str):
        ...
        llm_node = self._convert_to_llm_node(
          ...
          ***REMOVED***le_upload=app_config.additional_features.file_upload if app_config.additional_features else None,
    ...
    def _convert_to_llm_node(
      ...
      ***REMOVED***le_upload: FileUploadConfig | None = None,
        ...
        knowledge_retrieval_node = next(
          ***REMOVED***lter(lambda n: n["data"]["type"] == BuiltinNodeTypes.KNOWLEDGE_RETRIEVAL, graph["nodes"]), None
        )
