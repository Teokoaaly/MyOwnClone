...
class MCPToolManageService:
    ...
    def _update_optional_fields(self, mcp_provider: MCPToolProvider, configuration: MCPConfiguration) -> None:
      ...
      ***REMOVED***eld_mapping = {"timeout": configuration.timeout, "sse_read_timeout": configuration.sse_read_timeout}
    ...
    def _process_headers(self, headers: dict[str, str], mcp_provider: MCPToolProvider, tenant_id: str) -> str | None:
      ...
      ***REMOVED***nal_headers = self._merge_headers_with_masked(incoming_headers=headers, mcp_provider=mcp_provider)
    ...
    def _process_credentials(
      ...
      ***REMOVED***nal_client_id, final_client_secret = self._merge_credentials_with_masked(
