...
class FileService:
    ...
    def upload_file(
      ...
      ***REMOVED***lename: str,
        ...
        if len(filename) > 200:
          ***REMOVED***lename = filename.split(".")[0][:200] + "." + extension
      ...
      ***REMOVED***le_key = "upload_files/" + (current_tenant_id or "") + "/" + file_uuid + "." + extension
    ...
    def upload_text(self, text: str, text_name: str, user_id: str, tenant_id: str) -> UploadFile:
      ...
      ***REMOVED***le_uuid = str(uuid.uuid4())
      ***REMOVED***le_key = "upload_files/" + tenant_id + "/" + file_uuid + ".txt"
