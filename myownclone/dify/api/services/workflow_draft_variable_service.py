      ...
      ***REMOVED***les: list[File] = []
        ...
        for draft_var in draft_vars:
            ...
            if isinstance(value, FileSegment):
              ***REMOVED***les.append(value.value)
            elif isinstance(value, ArrayFileSegment):
              ***REMOVED***les.extend(value.value)
  ...
  ***REMOVED***:
        ...
        if policy == _UpsertPolicy.OVERWRITE:
            stmt = stmt.on_duplicate_key_update(  # type: ignore[attr-defined]
              ...
              ***REMOVED***le_id=stmt.inserted.file_id,  # type: ignore[attr-defined]
            )
        elif policy == _UpsertPolicy.IGNORE:
