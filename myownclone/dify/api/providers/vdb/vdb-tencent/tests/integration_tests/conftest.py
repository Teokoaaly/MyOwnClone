...
class MockTcvectordbClass:
    ...
    def create_collection(
      ...
      ***REMOVED***lter_index_config: FilterIndexConfig | None = None,
        ...
        return RPCCollection(
          ...
          ***REMOVED***lter_index_config=filter_index_config,
            indexes=indexes,
        )
    ...
    def collection_hybrid_search(
      ...
      ***REMOVED***lter: Union[Filter, str] | None = None,
