...
class BaiduVector(BaseVector):
  ...
  ***REMOVED***ltering_index: str = "filtering_idx"
    ...
    def _create_table(self, dimension: int):
        ...
        with redis_client.lock(lock_name, timeout=60):
          ...
          ***REMOVED***elds.append(Field(VDBField.CONTENT_KEY, FieldType.TEXT, not_null=False))
          ***REMOVED***elds.append(Field(VDBField.METADATA_KEY, FieldType.JSON, not_null=False))
          ***REMOVED***elds.append(Field(VDBField.VECTOR, FieldType.FLOAT_VECTOR, not_null=True, dimension=dimension))
            ...
            indexes.append(
                FilteringIndex(
                  ...
                  ***REMOVED***elds=[VDBField.METADATA_KEY],
                )
            )
            ...
            indexes.append(
                InvertedIndex(
                  ...
                  ***REMOVED***elds=[VDBField.CONTENT_KEY],
                    params=InvertedIndexParams(
                        analyzer=analyzer,
                        parse_mode=parse_mode,
                        case_sensitive=True,
                    ),
                  ***REMOVED***eld_attributes=[InvertedIndexFieldAttribute.ANALYZED],
                )
            )
