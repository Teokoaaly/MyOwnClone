    ...
    def search_by_vector(self, query_vector: list[float], **kwargs: Any) -> list[Document]:
      ...
      ***REMOVED***lters = []
        ...
        if document_ids_filter:
          ***REMOVED***lters.append({"terms": {"metadata.document_id.keyword": document_ids_filter}})
        if self._using_ugc:
          ***REMOVED***lters.append({"term": {f"{ROUTING_FIELD}.keyword": self._routing}})
                        ...
                        "properties": {
                            ...
                            Field.VECTOR: {
                                ...
                                "method": {
                                    ...
                                    if index_params
                                  ***REMOVED*** dify_config.LINDORM_INDEX_TYPE,
                                    "space_type": index_params.get("space_type", "l2")
                                    if index_params
                                  ***REMOVED*** dify_config.LINDORM_DISTANCE_TYPE,
                                    "engine": "lvector",
                                },
                            },
                        }
