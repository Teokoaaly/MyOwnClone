...
class TestWorkflowHierarchyHelpers:
    ...
    def test_build_graph_parent_index_drops_ambiguous_parallel_like_predecessors(self):
      ***REMOVED***rst_parallel_node = _make_workflow_node_trace_info(
    ...
    def test_build_wrapper_groups_groups_loop_children_by_index(self):
      ...
      ***REMOVED***rst = _make_workflow_node_trace_info(
    ...
    def test_build_wrapper_groups_skips_ambiguous_container_graph_ids(self):
      ***REMOVED***rst_loop = _make_workflow_node_trace_info(
            node_execution_id="loop-execution-1",
            node_id="loop-node-1",
            node_type="loop",
        )
...
def test_workflow_trace_parents_serial_nodes_to_resolved_predecessor_span(
  ...
  ***REMOVED***rst_node = _make_node_execution(
        id="node-execution-1",
        node_execution_id="node-execution-1",
        node_id="node-1",
        node_type="tool",
    ...
    workflow_span = MagicMock(name="workflow-span")
    workflow_span._context_label = "workflow"
  ***REMOVED***rst_node_span = MagicMock(name="first-node-span")
  ***REMOVED***rst_node_span._context_label = "node-1"
  ...
  ***REMOVED***rst_node_call = _get_start_span_call(trace_instance.tracer.start_span, span_name="tool_Node")
...
def test_workflow_trace_groups_loop_iteration_children_under_wrapper_spans(
  ...
  ***REMOVED***rst_body_node = _make_node_execution(
        id="body-execution-1",
        node_execution_id="body-execution-1",
        node_id="body-node-1",
        node_type="tool",
  ...
  ***REMOVED***rst_wrapper_span = MagicMock(name="loop-wrapper-0")
  ***REMOVED***rst_wrapper_span._context_label = "loop-wrapper-0"
  ***REMOVED***rst_body_span = MagicMock(name="body-span-1")
  ***REMOVED***rst_body_span._context_label = "body-1"
    ...
    trace_instance.tracer.start_span.side_effect = [
        workflow_span,
        loop_span,
      ***REMOVED***rst_wrapper_span,
      ***REMOVED***rst_body_span,
        second_wrapper_span,
        second_body_span,
    ]
  ...
  ***REMOVED***rst_wrapper_call = _get_start_span_call(trace_instance.tracer.start_span, span_name="loop[0]")
    second_wrapper_call = _get_start_span_call(trace_instance.tracer.start_span, span_name="loop[1]")
  ***REMOVED***rst_body_call = trace_instance.tracer.start_span.call_args_list[3]
...
def test_workflow_trace_falls_back_to_workflow_span_for_parallel_like_ambiguous_predecessors(
  ...
  ***REMOVED***rst_parallel_node = _make_node_execution(
    ...
    child_node_span = MagicMock(name="child-node-span")
    child_node_span._context_label = "child"
  ***REMOVED***rst_parallel_node_span = MagicMock(name="first-parallel-node-span")
  ***REMOVED***rst_parallel_node_span._context_label = "parallel-1"
    second_parallel_node_span = MagicMock(name="second-parallel-node-span")
    second_parallel_node_span._context_label = "parallel-2"
    trace_instance.tracer.start_span.side_effect = [
        workflow_span,
        child_node_span,
      ***REMOVED***rst_parallel_node_span,
