...
def _build_wrapper_groups(
    ...
    for node_execution in node_executions:
        ...
        if not isinstance(created_at, datetime):
            created_at = datetime.now()
      ***REMOVED***nished_at = _node_finished_at(node_execution)
...
class ArizePhoenixDataTrace(BaseTraceInstance):
    ...
    def workflow_trace(self, trace_info: WorkflowTraceInfo):
      ***REMOVED***le_list = trace_info.file_list if isinstance(trace_info.file_list, list) else []
        ...
        metadata = wrap_span_metadata(
          ...
          ***REMOVED***le_list=safe_json_dumps(file_list),
      ...
      ***REMOVED***nalized_wrapper_keys: set[_WrapperGroupKey] = set()
        ...
        try:
            ...
            def finalize_wrapper_spans() -> None:
                for group_key, wrapper_span in list(wrapper_span_by_key.items()):
                  ...
                  ***REMOVED***nalized_wrapper_keys.add(group_key)
    ...
    def tool_trace(self, trace_info: ToolTraceInfo):
        ...
        metadata = wrap_span_metadata(
          ...
          ***REMOVED***le_url=trace_info.file_url or "",
        )
