...
class WeaveDataTrace(BaseTraceInstance):
    ...
    def workflow_trace(self, trace_info: WorkflowTraceInfo):
        ...
        workflow_run = WeaveTraceModel(
          ***REMOVED***le_list=trace_info.file_list,
            total_tokens=trace_info.total_tokens,
        ...
        for node_execution in workflow_node_executions:
          ...
          ***REMOVED***nished_at = created_at + timedelta(seconds=elapsed_time)
    ...
    def message_trace(self, trace_info: MessageTraceInfo):
      ...
      ***REMOVED***le_list = cast(list[str], trace_info.file_list) or []
    ...
    def tool_trace(self, trace_info: ToolTraceInfo):
        ...
        tool_run = WeaveTraceModel(
          ...
          ***REMOVED***le_list=[cast(str, trace_info.file_url)] if trace_info.file_url else [],
            attributes=attributes,
            exception=trace_info.error,
        )
