...
class GetRemoteFileInfo(Resource):
    ...
    def get(self, url: str):
        ...
        return RemoteFileInfo(
          ***REMOVED***le_type=resp.headers.get("Content-Type", "application/octet-stream"),
          ***REMOVED***le_length=int(resp.headers.get("Content-Length", 0)),
...
class RemoteFileUpload(Resource):
    ...
    def post(self, current_user: Account):
      ...
      ***REMOVED***le_info = helpers.guess_file_info_from_response(resp)
        ...
        try:
            upload_file = FileService(db.engine).upload_file(
              ***REMOVED***lename=file_info.filename,
                content=content,
