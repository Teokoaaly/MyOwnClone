...
class FileApi(Resource):
    ...
    def get(self):
        config = UploadConfig(
          ***REMOVED***le_size_limit=dify_config.UPLOAD_FILE_SIZE_LIMIT,
            batch_count_limit=dify_config.UPLOAD_FILE_BATCH_LIMIT,
          ***REMOVED***le_upload_limit=dify_config.BATCH_UPLOAD_LIMIT,
