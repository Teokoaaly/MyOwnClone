...
class DailyMessageStatistic(Resource):
    ...
    @console_ns.response(
      ...
      ***REMOVED***elds.List(fields.Raw(description="Daily message count data")),
    )
    @get_app_model
    @setup_required
    @login_required
...
class DailyConversationStatistic(Resource):
    ...
    @console_ns.response(
      ...
      ***REMOVED***elds.List(fields.Raw(description="Daily conversation count data")),
    )
    @get_app_model
    @setup_required
    @login_required
...
class DailyTerminalsStatistic(Resource):
    ...
    @console_ns.response(
      ...
      ***REMOVED***elds.List(fields.Raw(description="Daily terminal count data")),
    )
    @get_app_model
    @setup_required
    @login_required
...
class DailyTokenCostStatistic(Resource):
    ...
    @console_ns.response(
      ...
      ***REMOVED***elds.List(fields.Raw(description="Daily token cost data")),
    )
    @get_app_model
    @setup_required
    @login_required
...
class AverageSessionInteractionStatistic(Resource):
    ...
    @console_ns.response(
      ...
      ***REMOVED***elds.List(fields.Raw(description="Average session interaction data")),
    )
    @setup_required
    @login_required
    @account_initialization_required
...
class UserSatisfactionRateStatistic(Resource):
    ...
    @console_ns.response(
      ...
      ***REMOVED***elds.List(fields.Raw(description="User satisfaction rate data")),
    )
    @get_app_model
    @setup_required
    @login_required
...
class AverageResponseTimeStatistic(Resource):
    ...
    @console_ns.response(
      ...
      ***REMOVED***elds.List(fields.Raw(description="Average response time data")),
    )
    @setup_required
    @login_required
    @account_initialization_required
...
class TokensPerSecondStatistic(Resource):
    ...
    @console_ns.response(
      ...
      ***REMOVED***elds.List(fields.Raw(description="Tokens per second data")),
    )
    @get_app_model
    @setup_required
    @login_required
