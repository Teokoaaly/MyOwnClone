...
def _serialize_var_value(variable: WorkflowDraftVariable):
    ...
    match value:
        case FileSegment():
          ***REMOVED***le = value.value
          ***REMOVED***le.remote_url = file.generate_url()
        case ArrayFileSegment():
          ***REMOVED***les = value.value
            for file in files:
              ***REMOVED***le.remote_url = file.generate_url()
...
workflow_draft_variable_list_without_value_fields_copy["items"] = fields.List(
  ***REMOVED***elds.Nested(workflow_draft_variable_without_value_model), attribute=_get_items
)
...
workflow_draft_variable_list_fields_copy["items"] = fields.List(
  ***REMOVED***elds.Nested(workflow_draft_variable_model), attribute=_get_items
)
