...
class FileLifecycleManager:
    ...
    def save_with_lifecycle(self, filename: str, data: bytes, tags: dict[str, str] | None = None) -> FileMetadata:
        ...
        try:
          ...
          ***REMOVED***le_metadata = FileMetadata(
    ...
    def soft_delete_file(self, filename: str) -> bool:
        ...
        try:
            ...
            # Read file content
          ***REMOVED***le_data = self._storage.load_once(filename)
    ...
    def cleanup_old_versions(self, max_versions: int = 5, max_age_days: int = 30) -> int:
        ...
        try:
            ...
            try:
                ...
                # Group by file
              ***REMOVED***le_versions: dict[str, list[tuple[int, str]]] = {}
                    ...
                    if len(parts) >= 2:
                        ...
                        try:
                            ...
                            if base_filename not in file_versions:
                              ***REMOVED***le_versions[base_filename] = []
                          ***REMOVED***le_versions[base_filename].append((version_num, version_file))
                        except ValueError:
                            continue
    ...
    def get_storage_statistics(self) -> StorageStatisticsDict:
        ...
        try:
            ...
            for filename, metadata in metadata_dict.items():
              ***REMOVED***le_meta = FileMetadata.from_dict(metadata)
