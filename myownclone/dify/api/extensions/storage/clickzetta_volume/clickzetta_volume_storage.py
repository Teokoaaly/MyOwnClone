...
class ClickZettaVolumeStorage(BaseStorage):
        ...
        try:
            ...
            if not result:
                ...
                CREATE TABLE {table_name} (
                  ...
                  ***REMOVED***lename VARCHAR(255) NOT NULL,
    ...
    def save(self, filename: str, data: bytes):
        ...
        Args:
          ***REMOVED***lename: File path in volume
    ...
    def scan(self, path: str, files: bool = True, directories: bool = False) -> list[str]:
        ...
        Args:
          ...
          ***REMOVED***les: Include files in results
        ...
        try:
          ...
          ***REMOVED***:
            ...
            if rows:
                for row in rows:
                  ***REMOVED***le_path = row[0]  # relative_path column
                    ...
                    if volume_prefix == "USER VOLUME" and file_path.startswith(dify_prefix_with_slash):
                      ***REMOVED***le_path = file_path[len(dify_prefix_with_slash) :]  # Remove prefix
