...
- [ ] 7. Open the next improvement tranche from the OSINT handoff only after stabilization
  What to do / Must NOT do: once M8-M13 and VPS validation are ***REMOVED***, create the next execution plan for prompt versioning, schema-drift cleanup, and related observability/lead features; do not start coding those features in the same tranche as stabilization.
  Parallelization: Wave 5 | Blocked by: 6 | Blocks: ***REMOVED***
