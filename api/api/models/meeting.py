...
class Booking(DefaultFieldsDCMixin, TypeBase):
    ...
    visitor_name: Mapped[Optional[str]] = mapped_column(String(255), nullable=True, default=None)
    visitor_email: Mapped[Optional[str]] = mapped_column(String(255), nullable=True, default=None)
    date: Mapped[Optional[date]] = mapped_column(Date, nullable=True, default=None)
    start_time: Mapped[Optional[time_type]] = mapped_column(Time, nullable=True, default=None)
    end_time: Mapped[Optional[time_type]] = mapped_column(Time, nullable=True, default=None)
...
class Product(DefaultFieldsDCMixin, TypeBase):
    ...
    name: Mapped[str] = mapped_column(String(255), nullable=False)
    description: Mapped[Optional[str]] = mapped_column(LongText, nullable=True, default=None)
    price_cents: Mapped[Optional[int]] = mapped_column(Integer, nullable=True, default=None)
