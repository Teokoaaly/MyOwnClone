"""add MyOwnClone columns to existing tables — documents, messages, tenants, accounts
...
These are additive columns only; no existing base platform behaviour is altered.
